...
We also decide to analyse the clusters based on silhouette:

```{r fig.width= 10, fig.height=6}
s2<-fviz_silhouette(KMeans2Clusters)+ ggtitle(paste("k = 2", "avg sw=",format(round(KMeans2Clusters$silinfo$avg.width,3))))
s3<-fviz_silhouette(KMeans3Clusters)+ ggtitle(paste("k = 3", "avg sw=",format(round(KMeans3Clusters$silinfo$avg.width,3))))
s4<-fviz_silhouette(KMeans4Clusters)+ ggtitle(paste("k = 4", "avg sw=",format(round(KMeans4Clusters$silinfo$avg.width,3))))
s5<-fviz_silhouette(KMeans5Clusters)+ ggtitle(paste("k = 5", "avg sw=",format(round(KMeans5Clusters$silinfo$avg.width,3))))
