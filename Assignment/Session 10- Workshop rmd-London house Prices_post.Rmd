...
```{r, correlation table, warning=FALSE, message=FALSE, fig.width=10}
...
svmControl <- trainControl(method="cv", number=5, verboseIter = TRUE) #again, train controlling is done through cross validation
