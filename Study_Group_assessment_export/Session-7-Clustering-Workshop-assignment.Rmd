...
ggplot(userClusterCentersTransposed5, aes(x = variable, y = value)) +
  ...
  theme(text = element_text(size=10),
        axis.text.x = element_text(angle=45, hjust=1),) +
  labs(subtitle = paste("Cluster Sizes: Cluster 1:", KMeans5Clusters$size[1], "Cluster 2:",KMeans5Clusters$size[2], "Cluster 3:", KMeans5Clusters$size[3], "Cluster 4:", KMeans5Clusters$size[4], "Cluster 5:", KMeans5Clusters$size[5]))
...
```{r }
#PCA visualizations
fviz_cluster(KMeans3Clusters, userdatall, palette = "Set2", ggtheme = theme_bw(), geom="point", pointsize = 0.5)
